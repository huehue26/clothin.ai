...
function Header() {
  ...
  return (
    <div className="bg-white pb-3 relative md:sticky top-0 z-10 shadow-md">
      <div className="container mx-auto px-6 py-3">
        <div className="flex items-center justify-between">
          ...
          <Link href="/" className="w-full md:text-center text-2xl coloured-logo">
            Clothin.ai
          </Link>
          ...
          <div className="flex items-center justify-end w-full">
            ...
            <Link href={ROUTES.cart()}>
              <button
                ...
                title="Shopping Cart"
              >
                <AiOutlineShoppingCart size={40} className="h-5 w-5" />
